...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func applicationDidEnterBackground(application: UIApplication) {
        ...
        NSNotificationCenter.defaultCenter().postNotificationName(BorrowingConstants.SaveBorrowersFor3DTouch, object: nil)
    }
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("You_owe_me", withExtension: "momd")!
